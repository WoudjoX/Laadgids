// Statische pagina's: over, contact, privacy. Korte, feitelijke tekst, zonder namen of bedrijfsnamen (keuze van de eigenaar).
  ...
  "nl-BE": {
    about: {
      ...
      paragraphs: [
        ...
        "Laadgids verdient aan offerteaanvragen die we doorsturen naar erkende installateurs en aan verwijzingen naar energieleveranciers. Dat beïnvloedt de berekeningen niet.",
      ],
    },
    contact: {
      slug: "contact",
      title: "Contact",
      paragraphs: [
        "Vragen over een berekening, een fout gevonden of een installateur die wil meewerken: mail naar info@laadgids.be.",
    ...
    privacy: {
      ...
      paragraphs: [
        ...
        "E-mails versturen we via een verwerker in de EU. Je kunt je gegevens laten inkijken, verbeteren of verwijderen via info@laadgids.be.",
        "Verantwoordelijke voor de verwerking: de uitgever van laadgids.be, bereikbaar via info@laadgids.be.",
      ],
    },
  },
  "fr-BE": {
    about: {
      ...
      paragraphs: [
        ...
        "Laadgids est rémunéré par les demandes de devis transmises à des installateurs agréés et par des renvois vers des fournisseurs d'énergie. Cela n'influence pas les calculs.",
      ],
    },
    contact: {
      slug: "contact",
      title: "Contact",
      paragraphs: [
        "Une question sur un calcul, une erreur repérée ou un installateur qui veut collaborer : écrivez à info@laadgids.be.",
    ...
    privacy: {
      ...
      paragraphs: [
        ...
        "Les e-mails sont envoyés via un sous-traitant établi dans l'UE. Vous pouvez consulter, corriger ou supprimer vos données via info@laadgids.be.",
        "Responsable du traitement : l'éditeur de laadgids.be, joignable via info@laadgids.be.",
      ],
    },
  },
  "nl-NL": {
    ...
    contact: {
      slug: "contact",
      title: "Contact",
      paragraphs: ["Vragen, fouten of installateurs die willen meewerken: mail naar info@laadgids.be."],
    },
    privacy: {
      slug: "privacy",
      title: "Privacy",
      ...
      paragraphs: [
        ...
        "Je kunt je gegevens laten inzien, corrigeren of verwijderen via info@laadgids.be. Verantwoordelijke: de uitgever van laadgids.be.",
      ],
    },
  },
};
